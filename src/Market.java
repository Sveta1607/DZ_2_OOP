...
public  class Market implements MarketBehaviour, QueueBehaviour {
    ...
    @Override
    public void giveOrders(Human actor, List<Product> products) { // сделать заказ/добавить список продуктов
    ...
    public void giveOrder(Human actor, Product product) { // сделать заказ/добавить продукт
        if (actor.isMakeOrder()) {
            System.out.printf("%s дополнил заказ.\n", actor.getName());
        }else{
            System.out.printf("%s сделал заказ.\n", actor.getName());
